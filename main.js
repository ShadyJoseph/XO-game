...
function winner(num1, num2, num3) {
  ...
  if (
    ...
    document.querySelector("#item" + num1).style.backgroundColor =
      "var(--yellow)";
    document.querySelector("#item" + num2).style.backgroundColor =
      "var(--yellow)";
    document.querySelector("#item" + num3).style.backgroundColor =
      "var(--yellow)";
